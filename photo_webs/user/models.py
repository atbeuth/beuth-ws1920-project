...
class Profile(models.Model):
    ...
    profile_img = DefaultStaticImageField(
        ...
        default_image_path="profile_imgs/default_profile_img.jpeg",
    )
    profile_banner = DefaultStaticImageField(
        upload_to="profile_imgs",
        default_image_path="profile_imgs/default_profile_banner.jpeg",
    )
    ...
    )  # These users I am following
    followers = models.ManyToManyField(
        User, related_name="is_following", blank=True
    )  # These users are following me
...
class Follower(models.Model):
    follower = models.ForeignKey(
        User, related_name="followinga", on_delete=models.CASCADE
    )
    following = models.ForeignKey(
        User, related_name="followersa", on_delete=models.CASCADE
    )
